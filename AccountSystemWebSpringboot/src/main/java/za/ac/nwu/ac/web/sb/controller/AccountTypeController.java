...
public class AccountTypeController {
    ...
    public ResponseEntity<GeneralResponse<AccountTypeDto>> create(
            @ApiParam(value = "Request body to creaate a new AccountType",
                    required = true)
        ...
        @GetMapping("{mnemonic}")
    @ApiOperation(value = "Fetches the specified account.", notes = "Fetches the AccountType corresponding to the given mnemonic.")
    @ApiResponses(value = {
            @ApiResponse(code = 200, message = "Goal found", response = GeneralResponse.class),
            @ApiResponse(code = 400, message = "Bad Request", response = GeneralResponse.class),
            @ApiResponse(code = 404, message = "Sources not found", response = GeneralResponse.class),
            @ApiResponse(code = 500, message = "Internal Server Error", response = GeneralResponse.class)
    })
    ...
    public ResponseEntity<GeneralResponse<AccountTypeDto>> getAccountType(
        ...
        AccountTypeDto accountType = fetchAccountTypeFlow.getAllAccountTypeByMnemonic(mnemonic);
    ...
    @ApiResponses(value = {
            @ApiResponse(code = 200, message = "AccoutnType deleted.", response = GeneralResponse.class),
            @ApiResponse(code = 400, message = "Bad Request", response = GeneralResponse.class),
